...
unsigned char compteur_buffer_3=0;
unsigned char  compteur_buffer_4=0;
  ...
  {   /* check if we received a CAN frame */
    if(msgcan2.id == 0x7DF)
    {
       CAN_message_t msg2;
        msg2.id = PID_REPLY;
        msg2.len = 8;
        msg2.buf[0] = msgcan2.buf[0];
        msg2.buf[1] = msgcan2.buf[1];
        msg2.buf[2] = msgcan2.buf[2];
        msg2.buf[3] = msgcan2.buf[3];
        msg2.buf[4] = msgcan2.buf[4];
        msg2.buf[5] = msgcan2.buf[5];
        msg2.buf[6] = compteur_buffer_3++;
        msg2.buf[7] = compteur_buffer_4++;
        msg2.seq = 1;
        can2.write(msg2);
    }
